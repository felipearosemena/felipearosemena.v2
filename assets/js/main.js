...
(0, _lodash.map)(sections, function (section) {
...
function handleSection(eventName, sectionView) {
  ...
  if (isInView) {
    (0, _lodash.map)(images, function (image) {
      image.load();
    });
  }
...
},{"./modules/polyfills":2,"./modules/utils":3,"./modules/video":4,"./views/header":5,"./views/pageSections":6,"lodash":7,"pubsub-js":8}],2:[function(require,module,exports){
"use strict";
...
},{"viewport-units-buggyfill":9}],3:[function(require,module,exports){
"use strict";
...
function videoController() {
  ...
  var srcs = (0, _lodash.map)(videoEl.querySelectorAll('source'), function (sourceEl) {
...
var scrollY = fromEvent(window, 'scroll').map(function (e) {
  return window.scrollY;
});

var calcThreshold = function calcThreshold() {
  var t = undefined;
...
var threshold = fromEvent(window, 'resize').map(function (e) {
  return calcThreshold();
}).startWith(calcThreshold());

var foldChange = combineLatest(scrollY, threshold, function (y, t) {
  return y > t;
}).distinctUntilChanged();

var toggleBtnClicks = fromEvent(document.querySelectorAll('.js-nav-toggle'), 'click');

var headerView = function headerView(el) {

  foldChange.subscribe(function (bool) {
    var method = bool ? 'add' : 'remove';
    document.body.classList[method]('is-below-fold');
  });

  toggleBtnClicks.subscribe(function (el) {
...
},{"../modules/utils":3}],6:[function(require,module,exports){
'use strict';
...
function pageSections(sectionEls) {
  ...
  var sectionViews = (0, _lodash.map)(sectionEls, function (section) {
...
},{"lodash":7,"pubsub-js":8}],7:[function(require,module,exports){
(function (global){
/**
 * @license
